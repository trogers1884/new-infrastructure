        ...
        $tblDef = "CREATE TABLE IF NOT EXISTS {$this->schema}.tbl_{$this->basename}
            (
                ...
                CONSTRAINT fk_{$this->basename}_roles_role_id FOREIGN KEY (role_id)
                    ...
                    ON DELETE NO ACTION
                    NOT VALID,
                CONSTRAINT fk_{$this->basename}_users_user_id FOREIGN KEY (user_id)
            ...
            ";
        $idxs = ([
            "CREATE UNIQUE INDEX unq_{$this->basename}_user_id_role_id ON {$this->schema}.tbl_{$this->basename} (user_id, role_id)"
